...
# AAD campaign data
  ...
  #      END AS ctrc_nbr,
        ...
        WHERE COLLATE(ordr.ctrc_nbr,'') NOT RLIKE '[^0-9]'# Exclude non-numeric TIMs for now; Will need to modify for wide Orbit. This will impact how TIM gets loaded into Tableau R/F
    ),
